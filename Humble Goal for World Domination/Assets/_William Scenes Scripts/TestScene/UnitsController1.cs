...
public class UnitsController1 : MonoBehaviour
{
    ...
    private void GetNextWayPoint()
    {
        if (wayPointIndex >= WP.wayPoints.Length -1)
        {
            ...
            GameObject.FindObjectOfType<PowerUps1>().Units.Remove(gameObject.GetComponent<UnitsController1>());
