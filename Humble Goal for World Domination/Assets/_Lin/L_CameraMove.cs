...
public class L_CameraMove : MonoBehaviour {
    ...
    [SerializeField] protected float _CameraDistance = 22.32f;
    ...
    void LateUpdate()
    {
        ...
        Quaternion QT = Quaternion.Euler(0, _LocalRotation.y, _LocalRotation.x);
        ...
        if (this._XForm_Camera.localPosition.z != this._CameraDistance )
        {
            ...
            this._XForm_Camera.localPosition = new Vector3(0, Mathf.Lerp(this._XForm_Camera.localPosition.y, this._CameraDistance , Time.deltaTime * ScrollDampening), 0f);
            /*
            if (fixedAngle == 0)
            {
                Debug.Log("Angle==0");
